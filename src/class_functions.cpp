...
//130724 Building AIM5, PZi
///////////////////////////////////////////////////////////////////////////////
Aim::Aim(Module *module_list,int num_modules) : range_fft_cfg(nullptr),
...
range_fft_size(0)
{
	...
	com_index_arrays();
	// Call the helper function *after* aim[90] (N) is defined by def_seeker()
	initialize_fft_resources();
}
...
Aim::~Aim()
{
	...
	if (range_fft_cfg) free(range_fft_cfg); // Use free for kiss_fft_alloc result
	delete[] range_fft_in;                  // Use delete[] for new[] result
	delete[] range_fft_out;                 // Use delete[] for new[] result
}
///////////////////////////////////////////////////////////////////////////////
//Constructor initializing the modules and the module-variable arrays
//				  
